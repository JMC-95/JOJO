...
void Interface::playerMenu(HDC hdc)
{
	...
	{
		IMAGEMANAGER->frameRender("¸Þ´º", hdc, PLAYERMANAGER->getPlayer()[0]->getPlayerInfo().rc.left - 100, PLAYERMANAGER->getPlayer()[0]->getPlayerInfo().rc.top - 35, PLAYERMANAGER->getPlayer()[0]->getFrameX(), 1);
	}
