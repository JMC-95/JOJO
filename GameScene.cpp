...
HRESULT GameScene::init()
{
	...
	ENEMYMANAGER->getEnemy()[4]->setPosition(_mainMap->getMap()[125].rc);
	ENEMYMANAGER->getEnemy()[5]->setPosition(_mainMap->getMap()[165].rc);
	ENEMYMANAGER->getEnemy()[6]->setPosition(_mainMap->getMap()[205].rc);
	ENEMYMANAGER->getEnemy()[7]->setPosition(_mainMap->getMap()[225].rc);
	ENEMYMANAGER->getEnemy()[8]->setPosition(_mainMap->getMap()[265].rc);
	ENEMYMANAGER->getEnemy()[9]->setPosition(_mainMap->getMap()[148].rc);
	ENEMYMANAGER->getEnemy()[10]->setPosition(_mainMap->getMap()[168].rc);
	ENEMYMANAGER->getEnemy()[11]->setPosition(_mainMap->getMap()[208].rc);
	ENEMYMANAGER->getEnemy()[12]->setPosition(_mainMap->getMap()[228].rc);
	ENEMYMANAGER->getEnemy()[13]->setPosition(_mainMap->getMap()[248].rc);
	ENEMYMANAGER->getEnemy()[14]->setPosition(_mainMap->getMap()[167].rc);
	ENEMYMANAGER->getEnemy()[15]->setPosition(_mainMap->getMap()[187].rc);
	ENEMYMANAGER->getEnemy()[16]->setPosition(_mainMap->getMap()[207].rc);
	ENEMYMANAGER->getEnemy()[17]->setPosition(_mainMap->getMap()[227].rc);
	ENEMYMANAGER->getEnemy()[18]->setPosition(_mainMap->getMap()[169].rc);
	ENEMYMANAGER->getEnemy()[19]->setPosition(_mainMap->getMap()[189].rc);
	ENEMYMANAGER->getEnemy()[20]->setPosition(_mainMap->getMap()[209].rc);
	ENEMYMANAGER->getEnemy()[21]->setPosition(_mainMap->getMap()[229].rc);
	ENEMYMANAGER->getEnemy()[22]->setPosition(_mainMap->getMap()[188].rc);
...
void GameScene::render()
{
	...
	if (PLAYERMANAGER->getPturn())
	{
		if (pTurnCount < 60)
		{
			...
			HFONT myFont = CreateFont(100, 0, 0, 0, 0, 0, 0, 0, DEFAULT_CHARSET, 0, 0, 0, 0, "나눔고딕 ExtraBold");
			...
			HFONT myFont2 = CreateFont(72, 0, 0, 0, 0, 0, 0, 0, DEFAULT_CHARSET, 0, 0, 0, 0, "나눔고딕");
			HFONT oldFont2 = (HFONT)SelectObject(getMemDC(), myFont2);
			SetTextColor(getMemDC(), RGB(255, 255, 255));
			sprintf_s(str, "제 %d턴", pTurn);
	...
	HFONT myFont = CreateFont(25, 0, 0, 0, 0, 0, 0, 0, DEFAULT_CHARSET, 0, 0, 0, 0, "나눔고딕 ExtraBold");
	HFONT oldFont = (HFONT)SelectObject(getMemDC(), myFont);
	SetTextColor(getMemDC(), RGB(255, 255, 255));
	sprintf_s(str, "턴 수");
